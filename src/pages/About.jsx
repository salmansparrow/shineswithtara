...
const About = () => {
  ...
  return (
    <Layout>
      <HeroPage
        follow="Muslim Islamic Cartoon"
        explore="Shine With Tara"
        subtitle="Halal Education Animation"
      />
      ...
      >
        ...
        <Box sx={{ p: 2, mt: 4 }}> {/* Responsive padding */}
          {activeSection === "mission" && (
            <Box sx={{ mt: 2 }}>
              <Typography variant="h6" color="#fff">
                Our mission is to become a trusted source of Islamic education for children worldwide, promoting understanding, compassion, and cultural appreciation through captivating animation and meaningful narratives.
              </Typography>
              <img 
                src={mission} 
                alt="Mission" 
          ...
          {activeSection === "vision" && (
            <Box sx={{ mt: 2 }}>
              <Typography variant="h6" color="#fff">
                Our vision is to inspire a new generation of young Muslims through engaging, entertaining, and educational animations that reflect their beliefs.
              </Typography>
              <img 
                src={vision} 
                alt="Vision" 
                style={{ width: "100%", height: "auto", marginTop: "16px", paddingLeft: 0, paddingRight: 0 }} // Set padding to zero for left and right
              />
            </Box>
          )}
        </Box>
